...
def main():
    ...
    data_configs = [
        ...
        #  pd.date_range(start="2017-01-01", end="2020-04-01", freq='D').astype(str), 'project_nav_dict3.pickle', 'https://api.sec.or.th/FundDailyInfo/{proj_id}/dailynav/{date}', fund_daily_subscription_keys),
        # (project_for_nav_df['project_id'],
        #  pd.date_range(start="2020-01-01", end="2020-04-01", freq='D').astype(str), 'project_nav_dict3.pickle', 'https://api.sec.or.th/FundDailyInfo/{proj_id}/dailynav/{date}', fund_daily_subscription_keys),
        # 01. NAV กองทุนรวมรายวัน
        # (PM_SET50_proj_ids,
        #  pd.date_range(start="2017-01-01", end="2020-04-01", freq='D').astype(str), 'project_nav_pm_dict.pickle', 'https://api.sec.or.th/FundDailyInfo/{proj_id}/dailynav/{date}', fund_daily_subscription_keys),
        # (PM_SET50_proj_ids,
        #  pd.date_range(start="2010-01-01", end="2020-04-01", freq='D').astype(str), 'project_nav_pm_dict.pickle', 'https://api.sec.or.th/FundDailyInfo/{proj_id}/dailynav/{date}', fund_daily_subscription_keys),
        ...
        #  'project_fund_top5_dict2.pickle', 'https://api.sec.or.th/FundFactsheet/fund/{proj_id}/FundTop5/{date}', fund_fact_subscription_keys),
    ]
